            ...
            <panel :title="$t('practice_sub_category')">
                ...
                <v-data-table :headers="headers" :items="practiceSubCategories" item-key="name" :pagination.sync="pagination"
                    ...
                    <template v-slot:items="props">
                        ...
                        <td>
                            <v-btn color="indigo" class="elevation-6" dark @click="navigateToView({
    ...
    export default {
        ...
        methods: {
            ...
            navigateToView(route) {
                let subCategory = this.practiceSubCategories.find(subCat => { return subCat.name === route.params.id});
